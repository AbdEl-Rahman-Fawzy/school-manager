...
public class Student extends User {
    ...
    public static List<Student> students = new ArrayList<>(); // Public static list of students
    ...
    public Student(int userID, String name, String email, String password, int studentID) {
        ...
        students.add(this); // Add student to the static list upon creation
    }
    ...
    public void addFeedback(String name, String feedback) {
        feedbacks.add("feedback from instructor" +name+ "/n is about /t "+feedback);
    }

    public void enrollCourse(int courseID) {
        enrolledCourses.add(Course.getCourse(courseID));
    }
}
